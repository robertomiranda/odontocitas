...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { celular: @paciente.celular, clave: @paciente.clave, correo: @paciente.correo, nombre: @paciente.nombre, telefono: @paciente.telefono, usuario: @paciente.usuario }
    end
  ...
  test "should update paciente" do
    put :update, id: @paciente, paciente: { celular: @paciente.celular, clave: @paciente.clave, correo: @paciente.correo, nombre: @paciente.nombre, telefono: @paciente.telefono, usuario: @paciente.usuario }
    assert_redirected_to paciente_path(assigns(:paciente))
  end

...
class SpecialitiesControllerTest < ActionController::TestCase
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post :create, speciality: { especialidad: @speciality.especialidad, id_odontologo: @speciality.id_odontologo }
    end
  ...
  test "should update speciality" do
    put :update, id: @speciality, speciality: { especialidad: @speciality.especialidad, id_odontologo: @speciality.id_odontologo }
    assert_redirected_to speciality_path(assigns(:speciality))
  end
